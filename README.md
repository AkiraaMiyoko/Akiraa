...
#Press R QUICKLY to restart before the game crashes. Im so sorry about this one because I'm too focused on the storyline and how the game works to the point that I have no tiem to debug the restart button. I have a major problem on this one since I struggle to debug the restart button. 

#Yellow door - this door will be uou chance of escape against the mysterious entity. 

#Keys (orange-yellowish small boxes) - you need to collect all of it under 30 seconds to escape throught the big yellow door and win the game. Collecting keys also increases your speed.
...
#------------
#GOODLUCK AT PLAYING, AND PELASE CONTACT ME IF THERE'S ANYTHING YOU NEED TO KNOW
#-----------
#AUTHOR'S NOTE:
#I have watched numerous youtube tutorials on how I made the game and I'm lwk proud of my work.
