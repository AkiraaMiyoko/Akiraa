...
• Press R QUICKLY to restart before the game crashes. Im so sorry about this one because I'm too focused on the storyline and how the game works to the point that I have no tiem to debug the restart button. I have a major problem on this one since I struggle to debug the restart button. But in soem cases the restart button doesn't crash the game.
